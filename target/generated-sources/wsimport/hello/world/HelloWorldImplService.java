 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://freelance.test.com/", wsdlLocation = "http://ec2-54-162-115-190.compute-1.amazonaws.com:8181/HelloWorldService/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://freelance.test.com/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://ec2-54-162-115-190.compute-1.amazonaws.com:8181/HelloWorldService/hello?wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://freelance.test.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://freelance.test.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
